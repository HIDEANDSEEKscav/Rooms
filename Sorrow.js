...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const dialogues = [
        "Welcome to the Sorrow Room. You are now standing in Green-Wood Cemetery, a place full of history and tranquility, our final stop.",
        "Each tombstone here tells a story, every corner is filled with memories of the past. ",
        " Look around, take the time to experience this emotion, feel the quiet, deep sadness and solemnity.",
        "Finally, please return to the menu, enter 0520, and find your key."
    ];

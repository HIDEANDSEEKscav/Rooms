...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const dialogues = [
        "Welcome to the Anxiety Room. Take a look around and deeply feel the atmosphere and your own emotions.",
        "Here, in Times Square, the hustle and bustle, the massive screens flickering with constantly changing images and sounds can overwhelm. ",
        "We are submerged in restlessness, overwhelmed by endless dynamics and noise. Feel the factors that drive your emotions, and seek calm amidst the pressure. ",
        "Now, continue your journey; the next location is Central Park."
    ];

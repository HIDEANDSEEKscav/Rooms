...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const dialogues = [
        "Welcome to the Joy Room. This is Central Park, a place full of vitality and life, where countless people come every day to seek fun and relaxation. ",
        "Look around at the tree-lined paths, the children’s laughter in the playgrounds, and people leisurely enjoying the natural scenery.",
        "This environment naturally makes one feel happy, the perfect place to experience joy. Feel this happiness permeate every cell of your body. ",
        "Now, continue your exploration; the next location is Wall Street."
    ];
